...
import com.google.cloud.teleport.v2.transforms.KafkaToGCSOptions;
import com.google.cloud.teleport.v2.transforms.WriteToGCSUtility;
import com.google.cloud.teleport.v2.util.DurationUtils;
...
public class KafkaToGCSTest {
   ...
   * carried out. And throws Null Pointer Exception if invalid file format is passed.
   */
  @Test
  ...
  /**
   * Tests testFileFormat() with a invalid File format. Check whether Exception thrown matches the
   * expected Exception.
   */
  @Test
  public void testFileFormatInvalid() {
    ...
    exception.expect(IllegalArgumentException.class);
    WriteToGCSUtility.checkFileFormatFn(fileFormat);
  }

  /** Tests testFileFormat() with a valid File format. Check whether no exception is thrown. */
  @Test
